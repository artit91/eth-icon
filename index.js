...
export default class EthIcon extends React.PureComponent {
  ...
  componentWillReceiveProps(props) {
    if (this.scale !== props.scale) {
      this.scale = props.scale;
      this.bitmap = Bitmap(this.scale * 8, this.scale * 8);
    }
  }
  getSourceUrl() {
    ...
    drawIcon(this.bitmap.data, this.scale, this.props.address);
  ...
  render() {
    ...
    return (
      <img
        ...
        src={props.src || this.getSourceUrl()}
